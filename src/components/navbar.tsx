          ...
          <div className="flex justify-between items-center h-20">
            <div className="flex items-center pt-2 md:pt-0">
              <Link href="/" className="hover:opacity-80 transition-opacity duration-300">
                <div className="text-2xl font-bold text-white font-[family-name:var(--font-space-grotesk)] tracking-tight">
                  <span className="text-gray-300">Due</span><span className="text-white">Ready</span><span className="text-gray-400">.</span>
                </div>
              </Link>
            </div>
