...
export default function FinancialDueDiligencePrepPage() {
  useEffect(() => {
    ...
    document.title = "Financial Due Diligence for Startups | Fractional CFO & Investor-Ready Models"
    const metaDescription = document.querySelector('meta[name="description"]')
    if (metaDescription) {
      metaDescription.setAttribute('content', 'Get investor-ready financials with expert support. Clean models, credible forecasts, and fractional CFO guidance to help close your next round or acquisition.')
    }
  }, [])
