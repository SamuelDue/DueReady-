...
export default function ExpertsPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-black via-gray-950 to-gray-900 text-white relative overflow-x-hidden">
      ...
      {selectedExpert && (
        <div 
          className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-start sm:items-start sm:items-center justify-center p-4 pt-8 pb-8 sm:pt-4 sm:pb-4 overflow-y-auto pt-8 pb-8 sm:pt-4 sm:pb-4 overflow-y-auto"
          onClick={(e) => {
        ...
        >
          <div className="bg-gradient-to-br from-gray-900 to-gray-950 border border-white/20 rounded-md max-w-2xl w-full max-h-[calc(100vh-4rem)] sm:max-h-[calc(100vh-4rem)] sm:max-h-[90vh] overflow-y-auto my-auto my-auto">
            {(() => {
