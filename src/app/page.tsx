  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-black via-gray-950 to-gray-900 text-white relative overflow-x-hidden">
      ...
      <section className="py-16 px-12 sm:px-10 lg:px-12 border-t border-white/10 relative">
        <div className="max-w-6xl mx-auto">
          <div className="flex items-center justify-between mb-8 scroll-animate fade-up">
            <div>
              <h2 className="text-2xl sm:text-3xl font-bold text-white mb-2">
                Latest Resources
              </h2>
              <p className="text-gray-400">
                Free guides and insights to help you become deal-ready.
              </p>
            </div>
            <Button 
              variant="ghost"
              className="text-white hover:bg-white/30 hover:text-white transition-all duration-300 px-3 py-2 h-auto font-medium text-sm hidden sm:flex items-center justify-center min-h-[36px]"
              asChild
            >
          ...
          <div className="text-center mt-6 sm:hidden scroll-animate fade-up">
            <Button 
              variant="ghost"
              className="text-white hover:bg-white/30 hover:text-white transition-all duration-300 px-3 py-2 h-auto font-medium text-sm flex items-center justify-center min-h-[36px]"
              asChild
